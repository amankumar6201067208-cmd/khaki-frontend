  ...
  useEffect(() => {
    ...
    const loadTour = async () => {
      ...
      try {
        ...
        if (data && data.tourType === "private") {
          setTour(data);
        }

      } catch (err) {
        console.error("Error loading private tour:", err);
      }
      ...
      <div className="max-w-285 mx-auto mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            {/* Highlights */}
            <h3 className="font-bold mt-6 text-[24px]">
              HIGHLIGHTS
            </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            {tour.tourType === "private" && (
              <PrivateTourRequestForm tour={tour} />
            )}
